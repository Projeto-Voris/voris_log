...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            remappings=[
                ('/stereo1/camera_1/image_raw', '/SM3/left/image_raw'),
                ('/stereo1/camera_2/image_raw', '/SM3/right/image_raw'),
                ('/stereo2/camera_1/image_raw', '/SM4/left/image_raw'),
                ('/stereo2/camera_2/image_raw', '/SM4/right/image_raw'),
